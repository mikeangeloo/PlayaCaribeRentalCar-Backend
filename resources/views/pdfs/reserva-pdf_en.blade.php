...
<head>
    ...
    <title>PLAYACARIBE_RENTAL_CAR_RESERVATION_{{$contrato->num_contrato}}</title>
</head>
<style>
    p {
        margin: 0;
        ...
        <div style="width: 100%; display: table; background: #E6E6E6; padding: 3px">
            <div style="display: table-row">
                ...
                @if ($contrato->folio_cupon)
                    <p style="margin: 0; padding: 0; float: left"><strong>Applied Cupon:</strong> {{ $contrato->folio_cupon }}</p>
                @endif
