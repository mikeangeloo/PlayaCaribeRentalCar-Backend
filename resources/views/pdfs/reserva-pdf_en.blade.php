...
<body style="width: 100%;">
    <div  class="contrato" style="max-width: 100%;">
            ...
            <div style="display: table-row">
                <div style="display: table-cell; ">
                    ...
                    @if ($contrato->con_descuento != null)
                       <p style="font-size:18px; text-align: right"> <strong>Discont</strong> $ {{number_format($contrato->cobranza_calc[1]["amount"])}} MXN</p>
                    @endif
        ...
        <div>
            <div style="width: 100%;">
                <p style="font-size: 18px; font-weight: bold">CHARGES DESCRIPTION: </p>
            </div>
            <div style="width: 100%;">
                @foreach ($contrato->cobranza_reserva as $cobranza)
                    <p>
                        ...
                        @else
                            <span>CASH PAYMENT {{date_format(date_create($cobranza->fecha_cargo), 'd-F-Y')}} ${{$cobranza->monto}} </span>
                        @endif
                    </p>
                @endforeach
