...
<head>
    ...
    <title>PLAYACARIBE_RENTAL_CAR_RESERVA_{{$contrato->num_contrato}}</title>
</head>
<style>
    p {
        margin: 0;
        ...
        <div style="width: 100%; display: table; background: #E6E6E6; padding: 15px;">
            <div style="display: table-row">
                <div style="display: table-cell;">
                    <p style="font-size:20px;"> <strong>Información de la reservación:</strong></p>
                </div>
            </div>
        </div>
        <br>
